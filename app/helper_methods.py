...
marks_config = config["marks_config"]
...
def calculate_marks(question, user_answer):
    '''
...
def calculate_marks_and_dump_data(questions, form):
    """
        Typical question:
        ----------------
    ...
    for index in range(total_questions):
        ...
        marks, min_marks, max_marks = calculate_marks(question, user_answer)
