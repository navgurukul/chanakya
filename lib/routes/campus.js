...
module.exports = [
  ...
  {
    method: "PUT",
    path: "/campus/{studentId}",
    options: {
      description: "Update the red flag og the ",
      tags: ["api"],
      validate: {
        params: {
      ...
      handler: async (request) => {
        ...
        const updatedFlag = flag
          ? await studentCampusService.updateRedFlag(
  ...
  //   path: "/campus/{studentId}",
  //   options: {
  //     description: "Deletes the raised flag for the specified student",
  //     tags: ["api"],
  //     validate: {
  //       params: {
  ...
  //     handler: async (request) => {
  //       const { studentCampusService } = request.services();
  //       const data = await studentCampusService.delete(
  //         request.params.studentId
  //       );
  //       if (data) {
  //         return { success: true };
