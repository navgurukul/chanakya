...
module.exports = [
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { partnerService } = request.services();
        const res = await partnerService.getProgressMadeForGraph(
          request.params.partnerId
        );
  ...
  },
  {
    ...
    options: {
      description:
        'Get all partner group students details who joined campus for progress made.',
      tags: ['api'],
      validate: {
        params: Joi.object({
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        const fromDate = request.query.from;
        const toDate = request.query.to;
        const patnerIdsOfGroup = await partnerService.PartnerIdsFromPartnerGroupId(request.params.partnerGroupId)
        var result = []
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { partnerService } = request.services();
        const result = await partnerService.getStudentsForPartnerGroup(request.params.partnerGroupId)
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        ...
        const patnerIdsOfGroup = await partnerService.getNameForPartnerGroup(request.params.partnerGroupId)
