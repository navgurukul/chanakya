...
const commonPermissions = [...permissions.updateStage,...permissions.addOrUpdateContact,...permissions.updateStudentName,...superAdmin]
module.exports = [
    {
        method: "GET",
        path: "/rolebaseaccess",
      ...
      
    {
      ...
      options: {
        ...
        return await rolebaseService.addUser({email:"kirithiv@navgurukul.org",roles:[],privilege:[]})
...
},
{
  ...
  options: {
    ...
    handler: async (request) => {
    const { rolebaseService } = request.services();
    return await rolebaseService.updateUser(request.payload,request.params.id)
