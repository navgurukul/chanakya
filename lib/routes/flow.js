...
module.exports = (server, options) => ([
    ...
    },
    {
        ...
        options: {
            description: "Syncs the entire DB with the google sheet. and updating pending enrolment keys and students details.",
            tags: ['api'],
            handler: async (request, h) => {
                const { studentService } = request.services();
                let syncDatabase = new ChanakyaGSheetSync(studentService);
    ...
    },
    {
        ...
        options: {
            description: 'Sync the entire google sheet with DB. and updating database with students actual stage.',
            tags: ['api'],
            handler: async (request, h) => {
                const  studentService   = request.services();
                let syncSheet = new ChanakyaGSheetSync(studentService);
