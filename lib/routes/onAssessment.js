...
module.exports = [
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const enrolmentKey = await assessmentService.validateEnrolmentKey(request.params.enrolmentKey);
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request, h) => {
        ...
        const enrolmentKey = await internals.validateEnrolmentKey(assessmentService, request.params.enrolmentKey);
        ...
        // the frontend can ensure not showing a particular form for certain details on basis of the stage
