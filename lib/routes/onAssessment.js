    ...
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                // once student completed his test then no one given the test using same enrolment key.
                if (enrolmentKey.student.stage != 'completedTest') {
                    ...
                    throw Boom.notAcceptable(' This entry is unacceptable beacuse this enrolment key is already used by another student. Please call to Navgurukuls  helpline number and take new test.');
                }
            }
        }
    },
