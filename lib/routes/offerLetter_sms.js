    ...
    },
    {
        ...
        options: {
            ...
            handler: async (request) => {
                ...
                try {
                    const result = await whatsappOutreachService.bulkCreate(dataArr);
                    return { success: true, message: 'Bulk insert successful', data: result };
                } catch (error) {
                    logger.error('Error during bulk insert:', error);
                    throw Boom.internal('Failed to perform bulk insert', error);
                }
            },
        },
    },
        ...
        options: {
            ...
            handler: async (request) => {
                ...
                try {
                    ...
                    throw Boom.internal('Failed to fetch outreach data', error);
                }
            },
        },
    },
