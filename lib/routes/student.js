...
module.exports = [
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { studentService } = request.services();
        console.log("Student ............................", studentService);
        const fromDate = request.query.from;
        const toDate = request.query.to;
  ...
  },
  {
    ...
    options: {
      ...
      handler: async (request) => {
        const { studentService } = request.services();
        const { partner_id, name, evaluation, flag } = request.payload;
        ...
        const updatedFlag = flag
          ? await studentService.updateRedFlag(request.params.studentId, flag)
          : false;
        if (updatedFlag) {
