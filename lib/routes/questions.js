...
internals.questionOptionSchema = Joi.object({
    enText: QuestionOption.field("enText"),
    hiText: QuestionOption.field("hiText"),
...
module.exports = [
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                ...
                let questions = await questionService.findAll();
        ...
        options: {
            ...
            validate: {
                payload: internals.questionSchema.concat(Joi.object({
                    options: Joi.array().items(internals.questionOptionSchema)
                }))
            },
            handler: async (request, h) => {
                const { questionService } = request.services();
                let question = await questionService.create(request.payload);
    ...
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                const { questionService } = request.services();
                let question = await questionService.findById(request.params.questionId);
                return { data: question }
            }
        }
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                const { questionService } = request.services();
                let question = await questionService.update(request.payload);
                return { data: question }
            }
        }
    },
    {
        ...
        options: {
            ...
            handler: async (request, h) => {
                const { questionService } = request.services();
                let response = await questionService.delete(request.params.questionId);
                return { success: true }
            }
        }
    }
