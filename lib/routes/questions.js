...
module.exports = [
  ...
  {
    method: 'GET',
    path: '/questions/attempts/{enrolmentKey}',
    options: {
      description: 'Get the questions by a given enrolmentKey.',
      tags: ['api'],
      validate: {
        params: Joi.object({
      ...
      handler: async (request) => {
        ...
        const attempts = await questionAttemptService.findQuestionIdByEnrolmentKeyId(request.params.enrolmentKey);
        return attempts;
      },
    },
  },
