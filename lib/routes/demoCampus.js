...
module.exports = [
...

    {
        ...
        options: {
            ...
            validate: {
                query: joi.object({
                    ...
                    dataByIndexId: joi.number().integer()
        ...
        handler: async (request) => {
            ...
            const data = await demoCampusService.findall(request.query.limit, request.query.dataByIndexId);
            return data;
...

    {
        ...
        handler: async (request) => {
            const { demoCampusService } = request.services();
            const data = await demoCampusService.updateDataById(request.params.id, 
                request.payload.campus, 
                request.payload.phone_no);
            return data;
        }
