...
module.exports = {
  ...
  gSheet: {
    ...
    partnerEmailReport: {
      subject: 'Greetings from NavGurkul’s Admissions Team!',
      syncReportHTMLReport: `${__dirname}/helpers/templates/partnersReports.html`,
    },
  },
  ...
  AI_SENSY_API_KEY: process.env.AI_SENSY_API_KEY,
};
