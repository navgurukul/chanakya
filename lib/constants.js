...
module.exports = {
  ...
  // a student will be considered as a stale record if the stage hasn't been changed since the specified days
  ...
  typeOfTest: [
	...
	testCutoffMale: {
		// cut-off marks for online test for Male according to the version of test.
		v1: 21,
		v2: 15,
		v3: 15
	},
	testCutoffFemale:{
		// cut-off marks for online test for Female according to the version of test.
		v1: 19,
		v2: 15,
		v3: 15
	},
