...
const {
  studentStages, feedbackableStages, caste, religon, qualification, current_status,
  feedbackableStagesData, contact_type
} = commonConnfig;

module.exports = {
  incomingcall_type: ['requestCallback', 'getEnrolmentKey'],
