...
module.exports = {
    ...
    studentStages: [
        ...
        'completedTest',
        'Pending Callback for Query',
        '(For Review) Callback Query Resolved',
        'Query Resolved after Callback',
        'Test Passed',
        'Test Failed',
        'Pending Algebra Interview',
        '(For Review) Algebra Interview Done',
        'Pending Algebra Re-Interview',
        'Algebra Interview Fail',
        'Algebra Interview Waitlisted',
        'Pending Culture Fit Interview',
        '(For Review) Culture Fit Interview Done',
        'Pending English Interview',
        '(For Review) English Interview',
        'English Interview Fail',
        'Culture Fit Interview Waitlisted',
        'Culture Fit Interview Fail',
        'Pending Parent Conversation',
        'Parent Conversation Fail',
        'Pending Travel Planning',
        'Finalised Travel Plans',
        'Probation',
        'Finally Joined',
        'Dropped Out',
    ...
    gSheet: {
        ...
        mainSheetName: "Main Data", // this should be an exact string match. it is case sensitive
        emailReport: {
            // reporting details that need to be sent
            to: ['amar17@navgurukul.org'], 
            cc: [],
            subject: "GoogleSheet-Chanakya Sync Report."
        }
    },
    aws: {
        s3: {
