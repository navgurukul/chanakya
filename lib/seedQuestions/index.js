...
if (!module.parent) {
    ...
    let allQuestionAndPassageFlag = QuestionSeeder.addquestionsAndPassageFlag();
    ...
    if (questionTypeFlag == "mcqTest"){
        ...
        let config = QuestionSeeder.verifyEnglishConfigFile(questionsDir);
         ...
         let seeder = new englishTest(config, questionsDir, updateMdFlag, allQuestionAndPassageFlag);
         seeder.startParsing()
         .then(() => {
