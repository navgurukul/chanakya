...
class QuestionSeeder {
  ...
  createFinalData() {
    ...
    _.map(this.questions, (question, questionsIndex) => {
      _.map(question.choices, (choice, choiceIndex) => {
        ...
        _.map(['common_text', 'hi_text', 'en_text'], (prop) => {
  ...
  async uploadImages() {
    const allUploadPromises = _.map(this.questions, (question,
      ...
      const uploadPromises = _.map(['common_text', 'hi_text', 'en_text'], (prop) => this.uploadImagesOfTokens(choice.tokens[prop], questionsIndex, choicesIndex, prop));
