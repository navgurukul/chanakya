...
class QuestionSeeder {
    ...
    constructor(questionsDirPath, updateMDFiles, addAllQuestions) {
...
if (!module.parent) {
    ...
    if (addAllQuestionsFlag && updateMdFlag) {
        QuestionSeeder.showErrorAndExit("Both --addAllQuestions & --updateMD cannot be active at once.");
    }
    ...
    // start the parsing
    let seeder = new QuestionSeeder( QuestionSeeder.getQuestionDirValue(), updateMdFlag, addAllQuestionsFlag );
    seeder.startParsing()
    .then(() => {
