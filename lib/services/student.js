...
module.exports = class StudentService extends Schmervice.Service {
  ...
  async updateProvisionsData(student_id, provisions) {
    const { Student } = this.server.models();
    const updatedProvisions = await Student.query()
      .patch({ provisions })
      .where("id", student_id);
  ...
  async studentsDataForDashBoard(
    ...
    const { Student, Contact, Partner, Feedback, Campus, studentCampus } =
      this.server.models();
