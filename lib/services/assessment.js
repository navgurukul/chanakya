...
module.exports = class AssessmentService extends Schmervice.Service {
    ...
    async recordOfflineStudentAnswers(studentDetails, answers, questionSet, txn=null) {
        ...
        studentDetails.typeOfTest = 'offlineTest';
    ...
    async patchStudentDetails(key, details={}, txn=null) {
        ...
        // if student fill he/she's basic details then record he/she's stage as "basicDetailsEntered".      
        if (details.stage == null && key.student.stage != "completedTest"){
            details.stage = "basicDetailsEntered"
        }
        // once student completed test then on production level again ask to student hes other details at that time change hes stage as "completedTestWithDetails" 
        if(key.student.stage == "completedTest"){
            details.stage = "completedTestWithDetails"
        }
