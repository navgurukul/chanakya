...
module.exports = class SchoolService extends Schmervice.Service {
  ...
  async students_school_post(student_id, school_id) {
    const { StudentSchool } = this.server.models();
    try {
      console.log(student_id, school_id, 'student_id, school_id');
      const store = await StudentSchool.query().insert({ student_id, school_id });
  ...
  async students_school_update(id, school_id, student_id) {
    const { StudentSchool } = this.server.models();
    console.log(id, school_id, student_id);
    try {
