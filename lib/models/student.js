...
module.exports = class Student extends Model {
  ...
  static get joiSchema() {
    return Joi.object({
      ...
      currentStatus: Joi.number().integer().valid(..._
        .values(CONSTANTS.studentDetails.currentStatus)).allow(null),
      schoolMedium: Joi.number().integer().valid(..._
        .values(CONSTANTS.studentDetails.schoolMedium)).allow(null),
    ...
    return {
      ...
      feedbacks: {
        ...
        join: {
          ...
          to: ['feedbacks.student_stage', 'feedbacks.studentId'],
        },
      },
      danglingtranstions: {
        relation: Model.HasManyRelation,
        ...
        join: {
          ...
          to: ['stage_transitions.studentId', 'stage_transitions.toStage'],
        },
      },
      lastTransition: {
        relation: Model.BelongsToOneRelation,
