...
module.exports = class Student extends Model {
  ...
  static get joiSchema() {
    return Joi.object({
      ...
      stage: Joi.string().valid(CONSTANTS.studentStages).allow(""),
      ...
      partner_refer: Joi.number().integer().allow(null),
    });
  }
  ...
  static get relationMappings() {
    ...
    const StudentDonor = require("./student_donor");
    const StudentCampus = require("./student_campus");
    return {
      partner: {
