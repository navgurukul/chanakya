...
module.exports = class InterviewSlot extends Model {
  ...
  static get joiSchema() {
    return Joi.object({
      ...
      owner_id: Joi.number().integer().greater(0).allow(null),
      ...
      created_at: Joi.date(),
      update_at: Joi.date(),
      meet_link: Joi.string().allow(null),
      meet_link_status: Joi.boolean().allow(null).default(null),
      result_status: Joi.boolean().allow(null).default(null),
    });
  }
    ...
    return {
      user: {
        ...
        join: {
          ...
          through: {
            from: 'interview_owners.id',
            to: 'interview_owners.user_id',
          },
          to: 'c_users.id',
        },
      },
