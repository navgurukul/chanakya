...
exports.createTestAndAnswerKeyPDF = async function (questions, partnerName, assessmentName) {
  const q = htmlPageGenerator(CONSTANTS.questions.pdf.quesPaperTemplate, { questions, partnerName, setName: assessmentName }, outputQuestionHtml);
  const a = htmlPageGenerator(CONSTANTS.questions.pdf.answerKeyTemplate, { questions, partnerName, setName: assessmentName }, outputAnswerHtml);
