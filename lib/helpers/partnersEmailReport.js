 ...
 *
 * @param {*} data
 * @description checking the stage of the students and counting
 * @returns  a object containing the details needs to be mailto the partners
 */
exports.getTemplateData = (data) => {
  ...
  //   CONSTANTS.gSheet.emailReport.partnersReport,
  //   "utf-8"
  // );
  // const htmlString = handleBar.compile(source)(res);
  return res;
};
/**
 *
 * @param {*} data
 * @param {*} stage
 * @description checking the status of the students
 */
