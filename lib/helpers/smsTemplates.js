...
smsTemplates.deadlineMessage = `Hello, {{=it.user.toAssign}} aap ko {{=it.user.whoAssign}} ne' {{=it.student.name}}' ka {{=it.student.stage}} ka interview assign kiya tha.

6 hours bache hai deadline khatam hone mei, please time se kar do!`;

smsTemplates.deadlineEndMessage = `Hello, {{=it.user.toAssign}} aap ko {{=it.user.whoAssign}} ne '{{=it.student.name}}' ka {{=it.student.stage}} ka interview assign kiya tha.

Aur uski deadline khatam ho gayi hai. Please jaldi se kar lo yaar!

Thank You!`;

smsTemplates.assignWork = `Hello, {{=it.user.toAssign}} aap ko {{=it.user.whoAssign}} ne '{{=it.student.name}}' ka {{=it.student.stage}} ka interview assign kiya hai.
...
module.exports = {
  ...
  colseBoysAdmission: dot.template(smsTemplates.closeBoysAdmission),
